...
const Pools: React.FC = ({}) => {
	...
	const showTokenDialog = (setFieldValue: (field: string, value: any) => void) => {
		show<Token>(TokenDialog, {
			chainId: getLabelById(chain, 'ethChainId', optionDatas?.chainInfoOpt || []),
		})
			.then((res) => {
														...
														<Grid item xs={12} sm={6} md={4} lg={4} xl={4} key={index}>
															...
															>
																<AuctionCard
																	...
																	dateStr={
																		fixedSwaptem.status == 1
																			? fixedSwaptem.openAt
																			: fixedSwaptem.closeAt
																	}
																	holder={
																		<AuctionHolder
																							...
																							(item: any, index: number) => {
																								return (
																									getLabelById(
																										item,
																										'role',
																										optionDatas?.publicRoleOpt,
																									) +
																									`${
																										index !==
																										fixedSwaptem.creatorUserInfo?.publicRole
																											?.length -
																											1
																											? ', '
																											: ''
																			...
																			<AuctionListItem
																				...
																				value={
																					<Stack direction="row" alignItems="center" spacing={4}>
																						...
																						/>
																						<span>
																							{shortenAddress(fixedSwaptem.token0.address)}
																						</span>
																	...
																	chainConfigInBackend={undefined}
																/>
															</Box>
														</Grid>
													))}
