		...
		return (
			...
			>
				...
				>
					...
					<Typography
						className="value"
						style={{ fontSize: 12, lineHeight: '18px', color: 'var(--ps-text-1)' }}
					>
			...
			{list && list.length >= 2 && (
				<ItemEl
					...
					style={{
						...
						left: isSm ? '-5%' : '50%',
						transform: isSm
							? 'translate3D(0, -49%, 0) scale(0.7)'
							: 'translate3D(-100%, -47%, 0) scale(0.8)',
						opacity: '0.5',
					}}
					index={2}
					data={list[1]}
