		...
		return (
			...
			>
				...
				>
					...
					>
						Congrats! Claim now all 3 Galxe NFTs below to be whitelisted for a unique lottery pool
						(optional):
					</Typography>
					{list.map((item, index) => {
						return (
					...
					>
						...
						>
							{checkJoinData?.timestamp
								? moment(Number(checkJoinData?.timestamp * 1000)).format('YYYY-MM-DD')
								: 'TBD'}
						</span>
					</Box>
				</Box>
		...
		return (
			...
			>
				...
				>
					...
					>
						Sign up now and unlock exclusive benefits and opportunities.Secure your spot in the IDO
						waiting list and be part of the next big thing!
					</Typography>
					<Box mb={10}>
						<Typography
							sx={{
			...
			>
					...
					<Box>
						...
						>
							...
							>
								...
								>
									PoseiSwap is the very first DEX on the Nautilus Chain,built to provide the best
									trading experience for users,liquidity providers and project developers.
								</Typography>
								<Box
									sx={{
										display: 'flex',
								...
								>
									<img
										...
										alt=""
										srcSet=""
										onClick={() => openLink('https://twitter.com/poseiswap')}
									/>
									<img
										src={TelegramIcon}
										alt=""
										srcSet=""
										onClick={() => openLink('https://t.me/PoseiSwapChat')}
									/>
									<img
										src={MediumIcon}
										alt=""
										srcSet=""
										onClick={() => openLink('https://poseiswap.medium.com/')}
									/>
									<img
										src={WebsiteIcon}
										alt=""
										srcSet=""
										onClick={() => openLink('https://www.poseiswap.xyz/')}
									/>
									<img
										src={DiscordIcon}
										alt=""
              ...
              /> */}
				...
				>
					{account && token ? (
						<>
							<JoinBtn onClick={handleConfirm}>
								{checkJoinData?.isJoin ? 'You joined' : 'Join waiting list'}
							</JoinBtn>
							{!userInfo?.email && (
								<Typography
									sx={{
