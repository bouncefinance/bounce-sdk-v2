...
export default function FixedSelected({
	handleSubmit,
}: {
	handleSubmit: (values: InitialValuesPros) => void
}) {
	...
	const SearchBox = (props: SearchBoxProps) => {
		...
		return (
			...
			>
				...
				/>
				{searchDialogOpen && (
					<SearchDialog title={'Search'} open={searchDialogOpen} list={selecteOption[5].list} />
				)}
			</Box>
		)
	}
