...
export default function Header() {
	...
	const isTransparentRoute = useMemo(
		() =>
			...
			transparentRoutes.some((route) => matchPath(route, pathname)),
		[pathname],
	)

	const isWhiteLogo = useMemo(
		() =>
			whiteLogoRoutes.includes(pathname) ||
			whiteLogoRoutes.some((route) => matchPath(route, pathname)),
		[pathname],
	)
