...
const Auction721ParametersForm = (): JSX.Element => {
	...
	const isOneNft = useMemo(
		() => valuesState.nft721TokenFrom.length === 1,
		[valuesState.nft721TokenFrom.length],
	)
					...
					return (
						...
						>
							<Box>
								<Typography
									variant="h3"
									sx={{ fontSize: 16, mb: 8, display: 'flex', alignItems: 'flex-start' }}
								>
									Auction Assets ({valuesState.nft721TokenFrom.length})
									<Tooltip title="If you choose multiple NFTs, it will be considered as a combination and will be auctioned together.">
									...
									<Box>
										...
										<Stack spacing={20} direction="row" sx={{ width: '100%' }}>
											<FormItem
												...
												startAdornment={
													<TokenImage
														alt={values.tokenToSymbol}
														src={values.tokenToLogoURI}
														size={32}
													/>
												}
											>
