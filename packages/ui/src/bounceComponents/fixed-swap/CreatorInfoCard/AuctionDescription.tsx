...
const AuctionDescription = ({
	...
	return (
		<Box sx={{ mt: 26, width: '100%' }}>
			<Box
				sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 36 }}
			>
						...
						<ButtonBase
							...
							onClick={() => {
								...
								update({
									...
									posts: poolInfo?.posts || undefined,
								})
							}}
						>
			...
			<Box sx={{ mt: 7 }}>
				{canEdit && isEditing ? (
					<Box sx={{ position: 'relative' }}>
						...
						<Typography
							variant="body2"
							sx={{ position: 'absolute', right: 16, bottom: 16, color: '#878A8E' }}
						>
