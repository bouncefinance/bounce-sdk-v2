...
const ActiveUserSkeletonCard = () => {
	...
	return (
		...
		>
			<Box
				sx={{
					width: isMd ? '198px' : '150px',
					height: isMd ? '198px' : '150px',
					borderRadius: '14px',
				}}
			>
				<Skeleton
		...
		>
			...
			>
				<H2 mb={isSm ? 20 : 80} ml={isSm ? 16 : 0}>
					Most active {isSm && <br />} <YellowSpan>auctioneers</YellowSpan> and{' '}
					<YellowSpan>bidders</YellowSpan>
				</H2>
			</Container>
			<SlideProgress
				hideArrow={isSm}
